...
Topic modeling identified rising themes in hate and toxicity across key topics: race, crime, and gender. More in-depth analysis can be found [here](../technical-report\docs\home\technical_report\appendix.md).
